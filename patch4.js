    ...
    try {
      ...
      if (CU.email) {
        await _p4_sendEmail(CU.email, CP.name || 'طالب', {
          ...
          platform: 'Skillak',
          platform_email: 'skillak.hub@gmail.com'
        });
      }
    ...
    setTimeout(() => {
      ...
      emailGuide.innerHTML = `
        ...
        <div class="cb">
          ...
          <p style="font-size:.75rem;color:var(--muted)">✉️ بريد المنصة: skillak.hub@gmail.com</p>
        </div>`;
...
console.log('✅ Skillak patch4.js v6.0 loaded | skillak.hub@gmail.com');
